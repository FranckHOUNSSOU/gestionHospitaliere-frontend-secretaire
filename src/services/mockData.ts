...
export const patients: Patient[] = [
  {
    ...
    bloodType: 'A+',
    insurance: 'CNSS',
    insuranceNumber: 'CNSS-2024-00145',
    emergencyContact: 'Mamadou Diallo',
    emergencyPhone: '+224 628 12 34 56',
  ...
  },
  {
    ...
    insuranceNumber: 'SUNU-2023-00892',
    emergencyContact: 'Kadiatou Bah',
    emergencyPhone: '+224 660 34 56 78',
  ...
  },
  {
    ...
    gender: 'F',
    phone: '+224 664 23 45 67',
    email: 'fatoumata.camara@email.com',
    address: '8 Quartier Madina',
    city: 'Conakry',
    bloodType: 'B+',
    insurance: 'UNICORP',
    insuranceNumber: 'UNI-2024-00234',
    emergencyContact: 'Oumar Camara',
    emergencyPhone: '+224 628 90 12 34',
  ...
  },
  {
    ...
    firstName: 'Mamadou',
    lastName: 'Kouyaté',
    dateOfBirth: '1960-05-18',
    gender: 'M',
    phone: '+224 622 56 78 90',
    email: 'mamadou.kouyate@email.com',
    address: '33 Cité des Nations',
    city: 'Kankan',
    bloodType: 'AB+',
    insurance: 'CNSS',
    insuranceNumber: 'CNSS-2022-01456',
    emergencyContact: 'Hadja Kouyaté',
    emergencyPhone: '+224 655 67 89 01',
  ...
  },
  {
    ...
    email: 'mariama.sylla@email.com',
    address: '17 Boulevard du Commerce',
    city: 'Conakry',
    bloodType: 'A-',
    insurance: 'Non assuré',
    insuranceNumber: '',
    emergencyContact: 'Sékou Sylla',
    emergencyPhone: '+224 664 45 67 89',
  ...
  },
  {
    ...
    gender: 'M',
    phone: '+224 655 90 12 34',
    email: 'souleymane.toure@email.com',
    address: '5 Rue des Fleurs',
    city: 'Labé',
    bloodType: 'O-',
    insurance: 'CNSS',
    insuranceNumber: 'CNSS-2021-00789',
    emergencyContact: 'Oumou Toure',
    emergencyPhone: '+224 622 78 90 12',
  ...
  },
  {
    ...
    gender: 'F',
    phone: '+224 660 56 78 90',
    email: 'hawa.balde@email.com',
    address: '22 Quartier Almamya',
    city: 'Conakry',
    bloodType: 'B-',
    insurance: 'Sunu Assurances',
    insuranceNumber: 'SUNU-2023-01123',
    emergencyContact: 'Ibrahima Baldé',
    emergencyPhone: '+224 664 12 34 56',
  ...
  },
  {
    ...
    gender: 'M',
    phone: '+224 628 67 89 01',
    email: 'alpha.conde@email.com',
    address: '88 Avenue Patrice Lumumba',
    city: 'N\'Zérékoré',
    bloodType: 'A+',
    insurance: 'CNSS',
    insuranceNumber: 'CNSS-2020-02345',
    emergencyContact: 'Aïssatou Condé',
    emergencyPhone: '+224 655 23 45 67',
...
export const appointments: Appointment[] = [
  ...
  },
  {
    id: 'a3',
    patientId: 'p4',
    patientName: 'Mamadou Kouyaté',
    doctorId: 'd5',
    doctorName: 'Dr. Ibrahim Sow',
  ...
  },
  {
    id: 'a5',
    patientId: 'p8',
    patientName: 'Alpha Condé',
    doctorId: 'd6',
    doctorName: 'Dr. Mariam Coulibaly',
  ...
  },
  {
    id: 'a7',
    patientId: 'p5',
    patientName: 'Mariama Sylla',
    doctorId: 'd7',
    doctorName: 'Dr. Oumar Bah',
    department: 'Urgences',
    date: '2026-04-15',
    time: '20:30',
    duration: 30,
...
export const admissions: Admission[] = [
  {
    ...
    expectedDischargeDate: '2026-04-20',
    department: 'Chirurgie',
    room: 'C-204',
    bed: 'B2',
    doctorId: 'd3',
    doctorName: 'Dr. Moussa Traoré',
    reason: 'Appendicite aiguë',
    diagnosis: 'Appendicite perforée',
    status: 'active',
    notes: 'Opération programmée le 17/04',
  },
  {
    id: 'adm2',
    patientId: 'p6',
    ...
    expectedDischargeDate: '2026-04-22',
    department: 'Médecine interne',
    room: 'MI-110',
    bed: 'B1',
    doctorId: 'd5',
    ...
    diagnosis: 'Diabète de type 2 avec complications',
    status: 'active',
  },
  {
    id: 'adm3',
    ...
    actualDischargeDate: '2026-04-16',
    department: 'Urgences',
    room: 'U-03',
    bed: 'B3',
    doctorId: 'd7',
    doctorName: 'Dr. Oumar Bah',
    reason: 'Traumatisme crânien léger',
    diagnosis: 'Commotion cérébrale légère',
    status: 'discharged',
  },
  {
    id: 'adm4',
    ...
    actualDischargeDate: '2026-03-08',
    department: 'Cardiologie',
    room: 'CARD-05',
    bed: 'B1',
    doctorId: 'd1',
